...
import { updateProductAction, fetchCategories, fetchSubcategories, getInventoriesAction } from "../redux/actions/addInventoryAction";
import { useNavigate, useParams } from "react-router-dom";
import { selectInventoryLoading, selectInventoryError, selectInventoryMessage, selectCategories, selectSubcategories, selectGetAllInventorys, selectStockStatus } from "../redux/selectors/selector";
const UpdateProduct = () => {
    const { sku } = useParams(); 
