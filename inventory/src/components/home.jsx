...
const HomePage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-tr from-violet-900 to-violet-300 flex flex-col md:flex-row px-4 py-16">
      <div className="max-w-5xl mx-auto text-center md:text-left flex-1">
        ...
        <div className="flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-6 mb-16">
          <Link to="/login">
            <button className="bg-blue-600 text-white px-10 py-4 rounded-lg hover:bg-blue-700 transition duration-300 ease-in-out text-center text-lg font-medium shadow-md transform hover:-translate-y-1 w-full">
              Login
            </button>
          </Link>
        </div>
